...
helpMessage ="""        ===Command Nciw===

􀜁􀇔􏿿 [Cancel]  > Cancel semua pendingan
􀜁􀇔􏿿 [Kick @]  > Kick dengan tag
􀜁􀇔􏿿 [Tagall]  > Tag semua pendingan
􀜁􀇔􏿿 [Sider]   > Set sider
􀜁􀇔􏿿 [Ciduk]   > Cek sider
...
#-----------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    if group.invitee is not None:
                        ...
                        if wait["lang"] == "JP":
                            cl.sendText(msg.to,"Gada pendingan Nciw pekok👈")
                        else:
